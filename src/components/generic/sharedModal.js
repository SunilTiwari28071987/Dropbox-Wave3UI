...
class ModalBox extends React.Component {
    ...
    submitModal(folderName) {
        console.log("Inside submit modal function",folderName);
        console.log(this.state);
        folderName ? this.props.creatingFolder(folderName) : null;
        this.props.onClick();
        this.closeModal();
    }
                                    ...
                                    <div className="panel-body">
                                        <form className="form-horizontal">
                                            <div className="form-group">
                                                <label className="col-sm-5 col-md-5 col-lg-5">Folder Name</label>
                                            ...
                                            <div className="form-group">
                                                <div className="row">
                                                    <div className="col-sm-offset-2 col-sm-2">
                                                        <button type="button" className="btn btn-primary" onClick={()=> {this.submitModal(this.state.folderName)}}>OK</button>
                                                    </div>
                                                    <div className=" col-sm-offset-2  col-sm-2">
